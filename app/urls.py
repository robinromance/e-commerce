...
urlpatterns = [
    ...
    path('update/<int:pk>', views.UpdateAddress.as_view(), name='update'),
...
#login Authentication
    ...
    path('password-reset-complete/', auth_view.PasswordResetCompleteView.as_view(template_name="app/password-reset-complete.html"), name='password_reset_complete'),
